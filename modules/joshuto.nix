{pkgs, ...}: {
  "joshuto/joshuto.toml".source = (pkgs.formats.toml {}).generate "joshuto.toml" {
    use_trash = true;
    watch_files = true;
    xdg_open = true;
    xdg_open_fork = true;
    ...
    preview = {
      ...
      preview_script = builtins.toFile "joshuto_preview_script.sh" ''
        #!/usr/bin/env bash
        ...
        exit 1
      '';
      preview_shown_hook_script = builtins.toFile "joshuto_preview_shown_hook_script.sh" ''
        #!/usr/bin/env bash
      ...
      '';
      preview_removed_hook_script = builtins.toFile "preview_removed_hook_script.sh" ''
        #!/usr/bin/env bash
