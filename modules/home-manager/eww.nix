{pkgs, ...}: {
  ...
  xdg.configFile = {
    "eww/eww.yuck".text = /* yuck */ ''
      (deflisten window :initial "" "bash ${pkgs.writeShellScript "get-window-title" /* bash */ ''
      ...
      ''}")
      (deflisten workspaces :initial "[]" "bash ${pkgs.writeShellScript "get-workspaces" /* bash */ ''
        spaces (){
      ...
      ''}")
      (deflisten current_workspace :initial "1" "bash ${pkgs.writeShellScript "get-active-workspace" /* bash */ ''
      ...
      ''}")
      (deflisten urgent_workspace :initial "" "bash ${pkgs.writeShellScript "get-urgent-workspace" /* bash */ ''
      ...
      (defwidget workspaces []
          (eventbox :onscroll "bash ${pkgs.writeShellScript "change-active-workspace" /* bash */ ''
            function clamp {
              min=''$1
              max=''$2
              val=''$3
